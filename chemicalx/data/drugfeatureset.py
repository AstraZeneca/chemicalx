...
class ContextFeatureSet(dict):
    ...
    def get_context_feature_count(self) -> int:
        """Getting the number of context feature dimensions.

        Returns:
            feature_count (int): The number of context feature dimensions.
        """
        feature_count = None
    ...
    def get_feature_density_rate(self) -> float:
        """Getting the ratio of non-zero feature values in the context feature matrix.
        ...
        if len(self.__dict__) > 0:
            ...
            context_count, feature_count = feature_matrix.shape
